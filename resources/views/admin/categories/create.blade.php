...
@section('content')
<div class="mb-4">
    <h1 class="oh-page-title">Create Category</h1>
    <p class="oh-page-sub">Add a new category to your product catalog.</p>
</div>
...
<div class="oh-form-card">
    <form action="{{ route('admin.categories.store') }}" method="POST">
        ...
        <div class="oh-field">
            ...
            <input type="text" name="name" class="oh-input" placeholder="e.g. Vegetables" required>
            @error('name')
        ...
        <div class="oh-form-actions">
            ...
            <button type="submit" class="oh-btn-primary">Save Category</button>
        </div>
    </form>
</div>
